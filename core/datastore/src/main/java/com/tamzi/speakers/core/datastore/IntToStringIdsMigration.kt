 ...
 */
object IntToStringIdsMigration : DataMigration<com.tamzi.speakers.core.datastore.UserPreferences> {

    override suspend fun cleanUp() = Unit

    override suspend fun migrate(currentData: com.tamzi.speakers.core.datastore.UserPreferences): UserPreferences =
        currentData.copy {
            // Migrate topic ids
    ...
    override suspend fun shouldMigrate(currentData: com.tamzi.speakers.core.datastore.UserPreferences): Boolean =
