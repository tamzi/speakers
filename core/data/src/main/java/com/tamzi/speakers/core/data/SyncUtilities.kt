...
interface Synchronizer {
     ...
     */
    suspend fun com.tamzi.speakers.core.data.Syncable.sync() = this@sync.syncWith(this@Synchronizer)
}
...
interface Syncable {
     ...
     */
    suspend fun syncWith(synchronizer: com.tamzi.speakers.core.data.Synchronizer): Boolean
}
 ...
 */
suspend fun com.tamzi.speakers.core.data.Synchronizer.changeListSync(
    versionReader: (ChangeListVersions) -> Int,
    changeListFetcher: suspend (Int) -> List<NetworkChangeList>,
    versionUpdater: ChangeListVersions.(Int) -> ChangeListVersions,
    modelDeleter: suspend (List<String>) -> Unit,
    modelUpdater: suspend (List<String>) -> Unit,
) = com.tamzi.speakers.core.data.suspendRunCatching {
