 ...
 */
import com.tamzi.speakers.NiaBuildType
...
android {
    defaultConfig {
        applicationId = "com.tamzi.speakers"
        versionCode = 5
        versionName = "0.0.5" // X.Y.Z; X = Major, Y = minor, Z = Patch level

        // Custom test runner to set up Hilt dependency graph
        testInstrumentationRunner = "com.tamzi.speakers.core.testing.NiaTestRunner"
        vectorDrawables {
